...
- **Expectation:** Each team member is expected to:
  ...
  - If team member(s) expect to not meet deadlines, they are expected to notify the team 1 week prior to deadline.  
...
**a. Team Leader/Coordinator: (Required)** Gerardo Ramirez
...
**b. Recorder/Secretary: (Optional)** Nick Romsdal 
...
- In the event the Team Lead is unavailable to fulfil roles in timely manner, the Team Lead may delegate decision to the team.
- Should the team agree to make amendments to this contract during the project, we reserve the right to meet and make amendments by vote with 80% quorum. Ratification of amendments must be approved by the instructor.  
